...
1. [Windows ZIP](https://github.com/Nukcanon/InternalNCrush/releases/tag/internal-n-crush-v1.0.3)을 모두 풀고 `InternalNCrush.exe`를 실행합니다. `.pck`는 EXE 옆에 둡니다.
2. 혼자라면 **연습 → 사격장 / 봇 연습**, LAN이라면 한 명이 **방 만들기**, 나머지는 **내부망 방 찾기 / IP로 접속**을 선택합니다.
