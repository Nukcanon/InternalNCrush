...
const SKILL_HELP = ["기동: 5초 고속이동 3초 빠른이동 · 재사용 24초", "감지 파동: 최소 35m / 맵 대각선 1/4 · 4초 표시 · 재사용 40초", "방호: 이동하며 6초 동안 전방 피해 85% 감소", "포탑: F 위치 선택, 클릭 설치 · F키로 업그레이드 · 전방 100도 · 자동 사격", "둔화 구역: 반경 15m / 8초 / 이동 속도 65% 감소 · 벽 너머 제외", "무적 보호: F 후 아군 클릭: 자신과 아군 / 빈 곳 클릭: 자신 · 6초 무적 · 재사용 45초"]
