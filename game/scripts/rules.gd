...
const GADGET_HELP = ["보호판 또는 파편 수류탄 선택 · 수류탄은 G 누르고 준비, 놓아 투척, 3초 지연", "표식기: 장착 시 자동 · 스코프 중앙에 가까운 적 1초 추적 → 팀 전체 6초 투시 · 대상에게 경고", "거치대: 앉아서 사용, 15초 동안 정지 사격 정확도 증가", "엄폐물: 조준 방향에 설치, 내구도별 선택", "연막탄 / 4 섬광탄: 선택 후 클릭하여 사용", "응급 키트: 가까운 아군 또는 자신을 25 회복"]
