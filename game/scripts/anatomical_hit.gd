...
static func trace(actor:Actor,from:Vector3,to:Vector3) -> Dictionary:
	...
	for part in [["Hips/LeftLeg/Knee/Foot",Vector3(0,-.025,-.065),Vector3(.045,.04,.1),"feet"],["Hips/RightLeg/Knee/Foot",Vector3(0,-.025,-.065),Vector3(.045,.04,.1),"feet"],["Hips",Vector3(0,-.02,0),Vector3(.143,.15,.115),"torso"],["Hips/Chest",Vector3(0,.012,0),Vector3(.162,.222,.115),"torso"],["Hips/Chest",Vector3(0,.25,0),Vector3(.043,.07,.042),"torso"],["Hips/Chest/Head",Vector3(0,.014,-.016),Vector3(.082,.126,.089),"head"]]:
		var transform:Transform3D=rig.get_node(part[0]).global_transform.affine_inverse()
