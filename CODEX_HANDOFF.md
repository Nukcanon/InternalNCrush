...
최종 공개 확인 기록은 아래 1.1.1 및 PUBLICATION_STATUS.json의 published_version이다. 1.1.2에는 웹 동적 저해상도 렌더링/256px 재질/추가 메시 축소, 손가락별 터치 입력, 여성 어깨 수정, 맵 조명 간섭 회피(캐시115), 봇7명/시작 장비 선택, 좁은 일시정지, 휠 전환, E 폭탄 안내, 즉시 장비 적용 StringName 명령 오류 수정, 재장전 후반 노리쇠 조작을 구현했다.

추가: 소유자 사망 시 포탑 파괴, 부활 스킬/가젯 쿨 초기화, 포탑100도·높이별 노출부 탐지, 봇 적 포탑 사격, 본인 설치물 팀색 투시 실루엣, 강화/설치 쿨타임 HUD 분리, 미사일30m/s. 전용236/236, 터치23/23, 로비49/49 통과. 구 로비 검사 버튼 이름은 새 시작 전 장비 선택 흐름에 맞게 수정했다. 전체 CI/최종 Windows ZIP/공개 웹 검증은 완료 후 아래 기록을 갱신할 것. GTX960와 실제 스마트기기는 미측정이다.
