...
| Shared game source | [games/relaystrike/](games/relaystrike/README.md) | Gameplay, models, arenas and tests |
| Shared lobby service | [services/matchmaker/](services/matchmaker/README.md) | API, allocator and Docker image source |

[Play and download](https://nukcanon.github.io/nukcanon/internal-n-crush.html) · [Releases](https://github.com/Nukcanon/InternalNCrush/releases) · [Request status](games/relaystrike/docs/REQUEST_STATUS.md) · [Validation](games/relaystrike/docs/TEST_REPORT.md) · [Handoff](CODEX_HANDOFF.md)
...
Geometry, animation and audio generators, redistribution notices and [art provenance](games/relaystrike/docs/ART_SOURCES.md) are included. Models and audio are rebuilt by CI.
